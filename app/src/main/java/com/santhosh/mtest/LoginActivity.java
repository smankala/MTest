...
public class LoginActivity extends AppCompatActivity{
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            try {
               ((MTestApplication) getApplication()).getPersistenceService().loginUser(email, password,
                           ...
                           public void handleLoginResponse(String token) throws RemoteException {
                              showProgress(false);
                               if (token == null) {
                                   ...
                                   bundle.putString(LoginSuccessActivity.USER_NAME,email);
                                   bundle.putString(LoginSuccessActivity.TOKEN,token);
